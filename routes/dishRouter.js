...
const mongoose = require('mongoose'); //Això no està sense utilitzar al vídeo
...
/* Particular dish' comment operations */
dishRouter.route('/:dishId/comments/:commentId')
    ...
    .post(authenticate.verifyUser, (req, res, next) => {
        res.statusCode = 403;
        res.end('POST operation not supported on a particular comment.');
    })
    .put(authenticate.verifyUser, (req, res, next) => {
        Dishes.findById(req.params.dishId)
        .then((dish) => {
